import { SQSClient, SendMessageBatchCommand, DeleteMessageCommand, ReceiveMessageCommand } from "@aws-sdk/client-sqs";
...
export const sendBatchToQueue = async (chunk: any[], index: number, metadata: any) => {
